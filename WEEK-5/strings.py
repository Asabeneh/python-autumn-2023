...
# creating string in python: single quote, double quote, triple quote
# how large is string: it could be a single character or multiple pages

char = 'a'
word = 'love'
print(char)
print(word)
sentence = 'I love Python but I use JavaScript most frequently'
print(sentence)
...
'''
print(donald_speech.split())
print(len(donald_speech))